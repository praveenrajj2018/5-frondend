...
//import DocumentViewerComponent from './DocuViewer';
import DocxToPdfConverter from './DocuViewer'
import DocxViewer from './DocuViewer';
...
setaddupdatebtn("Add")
  ...
  const handlePreview=(materialId, materialType)=>{
    ...
    switch (materialType) {
      ...
      case 'TEXT':
        setSelectedComponent(<PDFViewer materialId={materialId} />)
        break;
